...
function nextScene(location){
  ...
  if (buffer[0].indexOf("You") == 0 || buffer[0].indexOf("Shopper") == 0 || buffer[0].indexOf("Shopkeeper") == 0){
    ...
    if(buffer[0].indexOf("You") == 0){
      ...
      char.style.opacity = 0.5;
      if(buffer[0].indexOf("Shopper") == 0){
        document.getElementById("NPC").src = "/NCPs/NPC6_Shopper.png"
      }
      else{
        document.getElementById("NPC").src = "/NCPs/NPC5_ShopClerk.png"
      }
    }
  }
  else{
